            ...
            embeds: [
                {
                    ...
                    color: 0x00FFFF,
                    author: {
                        name: (await User.getUsernamesByUids([hookData.post.uid]))[0],
                        url: `https://the-starport.com/forum/user/${hookData.post.uid}`
                    },
                    timestamp: new Date(hookData.post.timestamp).toISOString(),
                    url: `https://the-starport.com/forum/post/${hookData.post.pid}`
                }
            ]
        })
    });

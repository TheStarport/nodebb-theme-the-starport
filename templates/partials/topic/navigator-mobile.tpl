<div class="d-flex w-100">
	<div class="pagination-block text-bg-light m-2 rounded-1 border w-100" style="height:30px;">
		...
		<div class="wrapper dropup-center d-flex align-items-center justify-content-between w-100 h-100" style="padding: 5px 0px;">
			...
			<a href="#" class="dropdown-toggle d-inline-block px-3 text-decoration-none" data-bs-toggle="dropdown">

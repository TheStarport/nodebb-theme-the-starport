<div class="w-100 mx-auto">
	...
	<div class="cover position-absolute start-0 top-0 w-100" component="account/cover" style="background-image: url({cover:url}); background-position: {cover:position};">
		<div class="container">
			...
			<div class="save text-bg-primary">[[groups:cover_save]] <i class="fa fa-fw fa-floppy-o"></i></div>
	...
	<div class="d-flex flex-column flex-md-row gap-2 w-100 pb-4 mb-4 border-bottom align-items-end">
		<div {{{ if (allowProfilePicture && isSelfOrAdminOrGlobalModerator)}}}component="profile/change/picture"{{{ end }}}
             class="avatar-wrapper border border-white border-4 rounded-circle position-relative align-self-center align-self-md-start hover-parent">

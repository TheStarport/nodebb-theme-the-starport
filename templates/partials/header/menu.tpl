<div class="d-flex align-items-center me-auto" style="min-width: 0px;">
    ...
    <div class="d-inline-flex align-items-center" style="min-width: 0px;">
        {{{ if brand:logo }}}
        <a class="navbar-title" href="{{{ if brand:logo:url }}}{brand:logo:url}{{{ else }}}{relative_path}/{{{ end }}}">
        ...
        <a class="navbar-title text-truncate" href="{{{ if title:url }}}{title:url}{{{ else }}}{relative_path}/{{{ end }}}">
            {config.siteTitle}
        </a>
        {{{ end }}}
    </div>
...
<div id="nav-dropdown" class="collapse navbar-collapse d-none d-lg-block">
    <ul id="main-nav" class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item {navigation.class}{{{ if navigation.dropdown }}} dropdown{{{ end }}}" title="{navigation.title}">
            <a class="navbar-link navigation-link {{{ if navigation.dropdown }}}dropdown-toggle{{{ end }}}"
    ...
    <ul class="navbar-nav mb-2 mb-lg-0 hidden-xs">
        <li class="nav-item">
            <a href="#" id="reconnect" class="navbar-link hide" title="[[global:reconnecting-message, {config.siteTitle}]]">
    ...
    <ul id="logged-out-menu" class="navbar-nav me-0 mb-2 mb-lg-0 align-items-center">
        ...
        <li class="nav-item">
            <a class="navbar-link" href="{relative_path}/register">
        ...
        {{{ end }}}
        <li class="nav-item">
            <a class="navbar-link" href="{relative_path}/login">

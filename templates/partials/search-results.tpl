{{{ if matchCount }}}
<div class="card card-header text-xs px-2 py-1 fw-semibold border-0 align-self-start">[[search:results-matching, {matchCount}, {search-query}, {time}]] </div>
{{{ else }}}
{{{ if search_query }}}
...
<div id="results" class="search-results" data-search-query="{search_query}">
	...
	<div class="topic-row  mb-3">
		<a class="topic-title fw-semibold fs-5 text-break" href="{config.relative_path}/post/{./pid}">

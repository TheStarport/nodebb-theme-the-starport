<div component="bottombar" class="bottombar d-flex flex-column d-lg-none fixed-bottom ff-secondary gap-1 align-items-center">
	...
	<div class="bottombar-nav p-2 text-dark bg-light d-flex justify-content-between align-items-center w-100">
		<div class="bottombar-nav-left d-flex gap-3 align-items-center">
			<div>
				<a href="#" role="button" class="navbar-link nav-btn d-flex justify-content-between align-items-center position-relative" data-bs-toggle="dropdown">
				...
				<ul class="navigation-dropdown dropdown-menu">
					...
					<li class="nav-item {./class}{{{ if ./dropdown }}} dropend{{{ end }}}" title="{./title}">
						<a class="navbar-link nav-btn navigation-link px-3 py-2 {{{ if ./dropdown }}}dropdown-toggle{{{ end }}}"
			...
			<div>
				...
				<ul id="logged-out-menu" class="list-unstyled d-flex w-100 gap-3 mb-0 logged-out-menu">
					...
					<li class="nav-item mx-2" title="[[global:register]]">
						<a class="navbar-link nav-btn" href="{relative_path}/register">
					...
					<li class="nav-item mx-2" title="[[global:login]]">
						<a class="navbar-link nav-btn" href="{relative_path}/login">

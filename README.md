...
This repository contains all of the preparatory work for a theme based off of the [the-starport theme](https://github.com/NodeBB/nodebb-theme-the-starport). If you'd like to base your theme off another supported theme instead, switch to the appropriate branch:
